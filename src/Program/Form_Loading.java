 ...
 * @author Viks
 */
public class Form_Loading extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        LoadBar.setForeground(new java.awt.Color(18, 79, 123));
        jPanel1.add(LoadBar);
        LoadBar.setBounds(30, 290, 700, 30);

        lbl_Icon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Gambar/load_bar.jpg"))); // NOI18N
        jPanel1.add(lbl_Icon);
        lbl_Icon.setBounds(0, -60, 760, 460);
